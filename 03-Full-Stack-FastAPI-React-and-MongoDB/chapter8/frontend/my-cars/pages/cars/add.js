  ...
  return (
    <div className='flex flex-col justify-center items-center h-full'>
      <div className=' shadow-lg p-5'>
        <h2 className=' text-orange-600 font-bold text-xl text-center my-3'>Add new car</h2>
        ...
        {!loading ? (
          <form className=' max-w-lg flex flex-col justify-center items-center' onSubmit={handleSubmit}>
            ...
            <button className='bg-orange-500 text-white p-2 m-3 w-full rounded-lg '>Submit</button>
          </form>
        ) : (
          <></>
        )}
